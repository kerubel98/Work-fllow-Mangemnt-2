...
const GlobalStandardDirectorySchema = new Schema({
...
export const GlobalStandardDirectoryModel = mongoose.model('GlobalStandardDirectory', GlobalStandardDirectorySchema);
