...
import { resolveFtpConfig, discoverFtpFilesRecursive, fetchRemoteFileBuffer } from './ftpConnectionService.js';
 ...
 */
function getSimulatedFileContent(filename) {
 ...
 */
function getSimulatedExcelBuffer() {
