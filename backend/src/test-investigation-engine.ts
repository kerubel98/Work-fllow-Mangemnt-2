...
import { 
  executeWorkflowForTransaction, 
  executeBatchInvestigation, 
  evaluateRuleCondition,
  evaluateDependencyCondition,
  resolveRuleAction
} from './services/investigationEngine.js';
import { DatabaseValidationWorkflow, ValidationCheckStep, ProcessingStage } from './types.js';
...
{
  const rule: ValidationCheckStep = {
    id: 'r1',
    stepNumber: 1,
    name: 'Status Match',
...
const baseStage: ProcessingStage = {
  id: 'stage-recon',
...
{
  const multiStageWorkflow: DatabaseValidationWorkflow = {
    id: 'wf-multi-stage',
...
{
  const settlementWf: DatabaseValidationWorkflow = {
    id: 'wf-settlement',
