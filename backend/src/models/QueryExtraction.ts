...
import { QueryExtraction } from '../types.js';

export interface IQueryExtraction extends Document, Omit<QueryExtraction, 'id'> {
  id: string;
}
...
export const QueryExtractionModel =
  mongoose.models.QueryExtraction ||
  mongoose.model<IQueryExtraction>('QueryExtraction', QueryExtractionSchema);
