...
import { InvestigationTask } from '../types.js';

export interface IInvestigationTask extends Document, Omit<InvestigationTask, 'id'> {
  id: string;
}
...
export const InvestigationTaskModel =
  mongoose.models.InvestigationTask ||
  mongoose.model<IInvestigationTask>('InvestigationTask', InvestigationTaskSchema);
