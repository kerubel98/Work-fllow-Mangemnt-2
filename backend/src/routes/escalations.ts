...
escalationsRouter.get('/issue/:issueId', async (req: Request, res: Response) => {
  try {
...
escalationsRouter.post('/command', async (req: Request, res: Response) => {
  try {
...
escalationsRouter.patch('/:id/status', async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
