import { User, Issue, HashtagPreset, Plugin, DatabaseConnection, EnvironmentSystem, Team, TeamTask, TeamInsight, TeamDiscussionMessage, AppNotification, DirectMessage, QueryApprovalRequest, DbAccessRequest, ConnectionUsageLog, Organization, TransactionTemplate, GlobalTransactionSchemaConfig, UploadedTransactionRecord, UploadAuditLog, WorkspaceTableRecord, GlobalStandardDirectoryRecord, DatabaseValidationWorkflow, QueryExtraction, InvestigationTask, InvestigationBatch, InvestigationTransaction, CentralTransactionRecord, ValidationBox, DatabaseColumnConfiguration, TeamRelationship } from '../types.js';
...
export const INITIAL_TEAM_RELATIONSHIPS: TeamRelationship[] = [
  {
    id: 'rel-seed-1',
    sourceTeamId: 'team-1',
...
export const INITIAL_WORKSPACE_TABLE_RECORDS: WorkspaceTableRecord[] = [
  {
    id: 'wtr-1001',
...
export const INITIAL_GLOBAL_STANDARD_DIRECTORY_RECORDS: GlobalStandardDirectoryRecord[] = [];

export const INITIAL_WORKFLOWS: DatabaseValidationWorkflow[] = [
  {
...
export class DataStore {
  ...
  public issues: Issue[] = [];
  public hashtags: HashtagPreset[] = [];
  public plugins: Plugin[] = [];
  public databases: DatabaseConnection[] = [];
  public systems: EnvironmentSystem[] = [];
  public teams: Team[] = [];
  public queryApprovals: QueryApprovalRequest[] = [];
  public dbAccessRequests: DbAccessRequest[] = [];
  public connectionLogs: ConnectionUsageLog[] = [];
  public notifications: AppNotification[] = [];
  public directMessages: DirectMessage[] = [];
  public teamTasks: TeamTask[] = [];
  public teamInsights: TeamInsight[] = [];
  public teamMessages: TeamDiscussionMessage[] = [];
  public organizations: Organization[] = [];
  public globalSchema: any = {
    version: '2.3.0',
  ...
  public tableMappings: Record<string, any> = {};
  public transactionTemplates: TransactionTemplate[] = [];
  public uploadedTransactions: UploadedTransactionRecord[] = [];
  public uploadAuditLogs: UploadAuditLog[] = [];
  public workspaceTableRecords: WorkspaceTableRecord[] = [];
  public globalStandardDirectory: GlobalStandardDirectoryRecord[] = [];
  public workflows: DatabaseValidationWorkflow[] = [];
  public queryExtractions: QueryExtraction[] = [];
  public investigationTasks: InvestigationTask[] = [];
  public investigationBatches: InvestigationBatch[] = [];
  ...
  public teamRelationships: TeamRelationship[] = [];
}
